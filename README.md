...
The IdentifiedSets module adds the concept of an ‘identified set’ to switch — a set of elements conforming to `Identifiable` that are added or removed to a set-like by their identifier.
